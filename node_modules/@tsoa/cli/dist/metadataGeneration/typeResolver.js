...
var TypeResolver = /** @class */ (function () {
        ...
        if (ts.isTypeLiteralNode(this.typeNode)) {
            var properties = this.typeNode.members
                ...
                var property = {
                    ...
                    deprecated: jsDocUtils_1.isExistJSDocTag(propertySignature, function (tag) { return tag.tagName.text === 'deprecated'; }),
                };
    ...
    TypeResolver.prototype.getDesignatedModels = function (nodes, typeName) {
        ...
        var designatedNodes = nodes.filter(function (enumNode) {
            return jsDocUtils_1.isExistJSDocTag(enumNode, function (tag) { return tag.tagName.text === 'tsoaModel'; });
        });
    ...
    TypeResolver.prototype.getEnumerateType = function (typeName) {
        ...
        return {
            ...
            refName: enumName,
            deprecated: jsDocUtils_1.isExistJSDocTag(enumDeclaration, function (tag) { return tag.tagName.text === 'deprecated'; }),
        };
    };
        ...
        try {
            ...
            if (ts.isTypeAliasDeclaration(declaration)) {
                ...
                referenceType = {
                    ...
                    deprecated: jsDocUtils_1.isExistJSDocTag(declaration, function (tag) { return tag.tagName.text === 'deprecated'; }),
                };
            }
            else {
    ...
    TypeResolver.prototype.getModelReference = function (modelType, name) {
        ...
        var deprecated = jsDocUtils_1.isExistJSDocTag(modelType, function (tag) { return tag.tagName.text === 'deprecated'; }) || decoratorUtils_1.isDecorator(modelType, function (identifier) { return identifier.text === 'Deprecated'; });
        ...
        if (toJSON && toJSON.valueDeclaration && (ts.isMethodDeclaration(toJSON.valueDeclaration) || ts.isMethodSignature(toJSON.valueDeclaration))) {
            ...
            var referenceType_1 = __assign({ refName: this.getRefTypeName(name), dataType: 'refAlias', description: description,
                type: type_2, validators: {}, deprecated: deprecated }, (example && { example: example }));
        ...
        var referenceType = __assign({ additionalProperties: additionalProperties, dataType: 'refObject', description: description, properties: inheritedProperties, refName: this.getRefTypeName(name), deprecated: deprecated }, (example && { example: example }));
    ...
    TypeResolver.prototype.propertyFromDeclaration = function (propertyDeclaration, overrideToken) {
        ...
        var property = {
            ...
            deprecated: jsDocUtils_1.isExistJSDocTag(propertyDeclaration, function (tag) { return tag.tagName.text === 'deprecated'; }) || decoratorUtils_1.isDecorator(propertyDeclaration, function (identifier) { return identifier.text === 'Deprecated'; }),
        };
        return property;
    };
